...
class AwardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post awards_url, params: { award: { description: @award.description, title: @award.title } }
    end
  ...
  test "should update award" do
    patch award_url(@award), params: { award: { description: @award.description, title: @award.title } }
